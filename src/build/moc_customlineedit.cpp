...
static constexpr auto qt_meta_stringdata_CLASSCustomLineEditENDCLASS = QtMocHelpers::stringData(
    "CustomLineEdit",
    "focused",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCustomLineEditENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCustomLineEditENDCLASS_t qt_meta_stringdata_CLASSCustomLineEditENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "CustomLineEdit"
        QT_MOC_LITERAL(15, 7),  // "focused"
        QT_MOC_LITERAL(23, 0)   // ""
    },
    "CustomLineEdit",
    "focused",
...
void CustomLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CustomLineEdit::*)();
            if (_t _q_method = &CustomLineEdit::focused; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
